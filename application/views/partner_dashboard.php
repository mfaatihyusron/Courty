    ...
    <div class="bg-white shadow-2xl rounded-xl border border-gray-100 p-8 mb-12">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-b pb-4 mb-4">
            ...
            <div class="mt-3 md:mt-0 space-x-3 flex">
                <a href="<?php echo site_url('App/edit_venue'); ?>" class="px-4 py-2 text-sm font-semibold text-white bg-indigo-500 rounded-lg shadow-md hover:bg-indigo-600 transition duration-150">
                    <i class="fas fa-edit"></i> Edit Venue
                </a>
                <a href="<?php echo site_url('App/add_court'); ?>" class="px-4 py-2 text-sm font-semibold text-white bg-[#B9CF32] rounded-lg shadow-md hover:bg-[#a6bd2e] transition duration-150">
                        ...
                        <?php foreach ($courts as $court): ?>
                            <tr class="hover:bg-gray-50 transition duration-100">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center space-x-2">
                                    <a href="<?php echo site_url('App/edit_court/' . $court['id_court']); ?>" class="text-indigo-600 hover:text-indigo-900 font-medium">Edit</a>
