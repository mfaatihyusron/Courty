<div class="max-w-xl mx-auto py-12">
    <div class="bg-white p-8 md:p-10 shadow-2xl rounded-xl border border-gray-100">
        <h1 class="text-3xl font-bold text-indigo-500 mb-2">Edit Detail Venue</h1>
        ...
        <?php echo form_open_multipart('praktek/edit_venue'); ?>
            ...
            <div class="mb-5 p-4 border border-dashed rounded-lg bg-gray-50">
                ...
                <p class="text-xs text-gray-500 mb-2">Foto saat ini: <a href="<?php echo base_url($venue['link_profile_img']); ?>" target="_blank" class="text-indigo-500 hover:underline"><?php echo html_escape($venue['link_profile_img']); ?></a></p>
            ...
            <button type="submit" 
                    class="w-full py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150">
